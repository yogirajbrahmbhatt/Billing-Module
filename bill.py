...
"background-color: rgb(255, 255, 127);")
        ...
        self.pushButton.clicked.connect(self.time.clear)
    ...
    def add2cart(self):
        if(str(self.iname.currentIndex()) == "-1"):
            
            from PyQt5.QtWidgets import QMessageBox
            msg = QMessageBox()
            msg.setIcon(QMessageBox.Critical)
            msg.setText("The item name is not selected yet")
            msg.setInformativeText('select something first...')
    ...
    def rem2cart(self):
        if(len(cart) == 0):
            ...
            msg = QMessageBox()
            msg.setIcon(QMessageBox.Critical)
            msg.setText("The cart is already EMPTY")
            msg.setInformativeText('Add something first...')
            msg.setWindowTitle("Oopssiee !!!")
            msg.exec_()
            pass
        else:
    ...
    def totall(self):
        if(sum(tpp) == 0):
            ...
            msg.setIcon(QMessageBox.Critical)
            msg.setText("The cart is already EMPTY")
            msg.setInformativeText('Add something first and then get the Total...')
            msg.setWindowTitle("Oopssiee !!!")
            msg.exec_()
            pass
    ...
    def menufunction(self, action):
        ...
        if(sum(tpp) != 0 and len(cart) != 0 and str(v) != ""):            
            ...
            if(str(v) == ""):
                ...
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Critical)
                msg.setText("The invoice number is not entered by you, its self generated...")
                msg.setInformativeText('Enter the proper Invoice Number first')
                msg.setWindowTitle("Oopssiee !!!")
                msg.exec_()
                self.billno.clear()
                pass
                ...
                msg.setIcon(QMessageBox.Critical)
                msg.setText("The cart is already EMPTY")
                msg.setInformativeText('Add something first and then get the Total...\n\nAND make sure you enter the proper invoice number')
                msg.setWindowTitle("Oopssiee !!!")
                msg.exec_()
                self.billno.clear()
                pass       
